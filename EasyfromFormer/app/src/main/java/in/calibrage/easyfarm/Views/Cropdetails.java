...
import in.calibrage.easyfarm.Adapter.CropDetailsAdapter;
...
public class Cropdetails extends CommonActivity {
        ...
        mSubscription = service.getSoildetailsbyplotcode(APIConstantURL.GetsoildetailsplotCode+code )
                ...
                .subscribe(new Subscriber<getSoiltestreports>() {
                    ...
                    public void onError(Throwable e) {
                        ...
                        mdilogue.dismiss();
                        showDialog(Cropdetails.this, getString(R.string.server_error));
                    }

                    @Override
                    public void onNext(getSoiltestreports getSoiltestreports) {
                        if (getSoiltestreports.getResult().getCropCycleInfo().size()!= 0 ) {
                            noRecords.setVisibility(View.GONE);
                            recyclerView.setVisibility(View.VISIBLE);
                            CropDetailsAdapter adapter = new CropDetailsAdapter(getSoiltestreports.getResult().getCropCycleInfo(), Cropdetails.this);
                            recyclerView.setAdapter(adapter);
